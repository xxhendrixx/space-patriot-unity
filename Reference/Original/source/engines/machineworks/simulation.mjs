...
/* MachineWorks 1.0 — deterministic game simulation. No browser, renderer, or dependencies. */
export const VERSION='1.0.0';
export const FORMAT='machineworks-project';
export const LIMITS=Object.freeze({machines:160,connections:640,parts:32,step:1/60,maxCatchUp:0.25});
...
export const PARTS=['panel','cylinder','gear','pipe','screen','antenna'];
...
export function createPreset(name='workshop'){
